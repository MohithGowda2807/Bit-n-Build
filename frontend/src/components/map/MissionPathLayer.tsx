...
export const MissionPathLayer: React.FC<MissionPathLayerProps> = ({
 ...
 const color = isSelected ? '#3d9bff' : '#2fae6e';
 ...
 opacity: 0.85
            ...
            >
              <Tooltip sticky>
                <div className="font-mono text-xs text-os-signal">
 ...
 const markerColor = isFirst ? '#0062ca' : isLast ? '#007afc' : '#e2a33a';
                ...
                >
                  <Tooltip direction="top" offset={[0, -8]}>
                    <div className="font-mono text-[11px]">
                      <span className="font-bold text-risk-moderate">WP #{idx}: </span>
