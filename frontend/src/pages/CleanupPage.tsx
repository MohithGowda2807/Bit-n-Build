...
export const CleanupPage: React.FC = () => {
 ...
 className="bg-os-panel border border-os-steel rounded-row px-3 py-1.5 text-xs font-mono text-white hover:text-white hover:border-os-silver transition flex items-center gap-1.5 cursor-pointer"
        >
